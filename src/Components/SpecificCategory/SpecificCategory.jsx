    ...
    {realatedProduct?.length != 0? <>{realatedProduct?.length > 0? realatedProduct?.map((product)=> (
      <div key={product.id} className="xl:w-1/6 md:w-1/4 ">
        ...
        <div className="product my-3 py-2 px-4">
          ...
          <h1 className='capitalize text-base md:text-3xl text-emerald-500 font-bold text-center my-20 mx-auto'><i className="fa-solid fa-cart-shopping fa-spin md:mx-6 "></i> No products in this Category <i className="fa-solid fa-cart-shopping fa-spin fa-spin-reverse md:mx-6"></i></h1>
          </>}
